...
<div class="bg-gray-50 z-50 fixed">
    <div class="overflow-y-hidden overflow-x-hidden h-screen z-20 scrolling-touch fixed top-0 md:left-0 -left-64 flex flex-row bg-gray-100 text-gray-800 bg-[#2C3639]">
        <aside class="sidebar h-screen w-64 md:shadow transform -translate-x-full md:translate-x-0 transition-transform duration-150 ease-in bg-[#776D8A]">
            <div class="flex flex-col items-center mt-6 -mx-2">
                ...
                <p class="mx-2 text-sm font-medium text-white hover:underline">{{ Auth::user()->email }}</p>
            </div>
            <div class="sidebar-content px-4 py-6">
                <ul class="flex flex-col w-full h-screen">
                    ...
                    <li class="my-px">
                        <a href="{{ route('admin.pesanan') }}" class="flex flex-row items-center h-10 px-3 text-gray-700 hover:bg-gray-100"><span class="flex items-center justify-center text-lg text-white"><svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6"> <path d="M6.5 0A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3Zm3 1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 .5-.5h3Z"/>
                    ...
                    <li class="my-px">
                        <a href="{{ route('admin.retur') }}" class="flex flex-row items-center h-10 px-3 text-gray-700 hover:bg-gray-100"><span class="flex items-center justify-center text-lg text-white"><svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"  viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6"><path d="M11.534 7h3.932a.25.25 0 0 1 .192.41l-1.966 2.36a.25.25 0 0 1-.384 0l-1.966-2.36a.25.25 0 0 1 .192-.41zm-11 2h3.932a.25.25 0 0 0 .192-.41L2.692 6.23a.25.25 0 0 0-.384 0L.342 8.59A.25.25 0 0 0 .534 9z"/>
                    ...
                    <button type="button" class="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 {{ Request::is('admin/laporan') ? 'bg-gray-100' : '' }}" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                        <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-white transition duration-75 group-hover:text-gray-900" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-folder-fill" viewBox="0 0 16 16">
    ...
    <div class="fixed w-full">
        <nav class="bg-[#776D8A] md:ml-64 py-4 px-3">
